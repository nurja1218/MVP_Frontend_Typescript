...
interface diffTimeTyep extends moment.Duration{
    _data : any
}

export default function InformationTable({ uuid, menuDetail, menuConfig, alarmData }: any) {
    const { t, i18n } = useTranslation();
    const [transportTime, setTransportTime] = useState<any>(null);
    ...
    const [locationInMap, setLocationInMap] = useState<any>({
        result: [],
    });
    ...
    useEffect(() => {
        ...
        if (menuConfig) {
            ...
            if (arrivalTime) {
                ...
                const diffTime: any = moment.duration(
                ...
                >
                    {alarmStateId === 'ABNORMAL' && (
                        ...
                        >
                            ...
                            menuConfig.alarmRangeStatusId === 'ABNORMAL'
                                ? alarmData.result.map((list: any, idx: any) => (
                                      <li key={idx}>
                                          <p>{list.date}</p>
                                          <span>
