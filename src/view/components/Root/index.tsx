...
export default function Root(props: any) {
    ...
    const setNeedRefetch: any = useSetRecoilState(needRefetchState);
    const filterAlarms: any = useSetRecoilState(notificationFilter);
    ...
    const onClick = (e: any) => setCollapsed(!collapsed);
