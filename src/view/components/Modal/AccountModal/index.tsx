...
export default function AccountModal({ status }: any) {
    ...
    const [modal, setModal] = useRecoilState<any>(accountModalState);
    const classes: any = useStyles();
    const roles = Object.keys(ACCOUNT_ROLES);
    const setNeedRefetch = useSetRecoilState<any>(needRefetchState);
    // 추후 "수정" 시 사용
